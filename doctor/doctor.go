...
var responses = [][]string{
	...
	{"Thank you for talking with me.", "Good-bye.", "Thank you, that will be $150.  Have a good day!", "Fine, be that way!"},
...
and lower-case letters and punctuation.  Enter 'quit' or 'exit' when done.
